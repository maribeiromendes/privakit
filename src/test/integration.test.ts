...
describe('Integration Tests', () => {
  ...
  describe('Cross-Module Integration', () => {
    it('should work seamlessly between detection and masking', () => {
      ...
      const emailSpans = detection.spans.filter(span => span.type === PIIType.Email);
    ...
    it('should integrate validation with policy engine', () => {
      ...
      const emailDecision = policyEngine.evaluate(PIIType.Email, PolicyOperation.Log);
      expect(emailDecision.allowed).toBe(false);
      
      // Check if ZIP code display is allowed
      const zipDecision = policyEngine.evaluate(PIIType.ZipCode, PolicyOperation.Display);
  ...
  describe('Real-world Scenarios', () => {
    ...
    it('should handle GDPR compliance scenario', () => {
      ...
      const text = 'Customer data: name=John Doe, email=john@example.com, address=123 Main St';
      ...
      const nameDecision = gdprEngine.evaluate(PIIType.Name, PolicyOperation.Transfer);
  ...
  describe('Error Handling and Edge Cases', () => {
    ...
    it('should handle mixed valid and invalid data', () => {
      const text = 'Valid email: user@example.com, Invalid: @invalid, Phone: 555-1234, Invalid phone: abc';
      ...
      const validSpans = result.detection.spans.filter(span => 
        span.text === 'user@example.com' || span.text === '555-1234'
      );
