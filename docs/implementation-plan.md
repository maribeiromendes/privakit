...
privakit/
├── src/
│   ├── core/           # ✅ Core types, errors, policy engine
│   ├── validate/       # ✅ Field validators (email, phone, name, address)
│   ├── normalize/      # ✅ Format normalizers
│   ├── mask/          # ✅ Display-safe masking
│   ├── redact/        # ✅ Hard redaction for logs
│   ├── detect/        # ✅ Pattern matching and span extraction
...
// Error handling
class PIIValidationError extends Error {}
...
- **Email Validation**: 20 tests (18 passing, 2 minor issues)
- **PII Detection**: 27 tests (20 passing, 7 pattern refinements needed)
- **Masking Functions**: 47 tests (40 passing, 7 format adjustments needed)
